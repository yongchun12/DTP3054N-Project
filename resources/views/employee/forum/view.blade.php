            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6" style="text-align: right">
                        <a href=" {{ url('employee/forum') }} " class="btn btn-primary"><i class="fa-solid fa-arrow-left mr-1"></i>Back</a>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        </div>
                    ...
                    <section class="col-md-12">
                        ...
                        <div class="card card-widget">
                                    ...
                                    <div class="card-comment">
                                        ...
                                        @if($data->employee_id == Auth::user()->id)
                                            <span class="float-right" style="margin-left: 10px;">
                                                    <a onclick="return confirm('Are you sure want to delete?')" href="{{ url('employee/forum/reply/delete/'.$data->id) }}">
                                        ...
                                        @if($data->employee_id == Auth::user()->id)
                                            <a href="{{ url('employee/forum/reply/edit/'.$data->id) }}">
                            ...
                            <div class="card-footer">
                                ...
                                <form method="post" accept="{{ url('employee/forum/view/'.$getRecord->id) }}}" enctype="multipart/form-data">
