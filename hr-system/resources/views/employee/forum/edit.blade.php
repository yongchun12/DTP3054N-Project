                ...
                <div class="row">
                    <section class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <form class="form-horizontal" method="post" accept="{{ url('employee/forum/edit/'.$getForum->id) }}}" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="card-footer">
                                        <a href=" {{ url('employee/forum') }} " class="btn btn-default"><i class="fa-solid fa-arrow-left mr-1"></i>Back</a>
